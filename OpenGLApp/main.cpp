...
void renderScene(unsigned int woodTexture, unsigned int containerTexture,
	std::vector<glm::vec3>& lightPositions, std::vector<glm::vec3>& lightColors,
	Shader& shader, Shader& shaderLight,
...
int main()
{
	...
	shaderBloomFinal.setInt("depthBuffer", 2);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shaderBloomFinal.setFloat("blurDepth", blurDepth);
		renderQuad();
